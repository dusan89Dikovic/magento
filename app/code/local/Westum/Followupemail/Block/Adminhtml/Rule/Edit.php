 ...
 *
 * @category   AW
 * @package    Westum_Followupemail
 * @version    3.5.8
 * @copyright  Copyright (c) 2010-2012 aheadWorks Co. (http://www.aheadworks.com)
 * @license    http://ecommerce.aheadworks.com/AW-LICENSE.txt
 */

class Westum_Followupemail_Block_Adminhtml_Rule_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_formScripts[] = "
            ...
            function doBirthdayChanges(){
                if( $('event_type').getValue() == '"
            . Westum_Followupemail_Model_Source_Rule_Types::RULE_TYPE_CUSTOMER_BIRTHDAY . "' )
                {
            ...
            function checkEventType(){
                ...
                if(
                    $('event_type').getValue() == '"
            . Westum_Followupemail_Model_Source_Rule_Types::RULE_TYPE_CUSTOMER_NEW . "' ||
                    $('event_type').getValue() == '"
            . Westum_Followupemail_Model_Source_Rule_Types::RULE_TYPE_CUSTOMER_BIRTHDAY . "' ||
                    $('event_type').getValue() == '"
            . Westum_Followupemail_Model_Source_Rule_Types::RULE_TYPE_CUSTOMER_LOGGED_IN . "' ||
                    $('event_type').getValue() == '"
            . Westum_Followupemail_Model_Source_Rule_Types::RULE_TYPE_CUSTOMER_LAST_ACTIVITY . "' ||
                    $('event_type').getValue() == '"
                        . Westum_Followupemail_Model_Source_Rule_Types::RULE_TYPE_CUSTOMER_CAME_BACK_BY_LINK . "')
                {
                    ...
                    $('event_type').getValue() == '"
            . Westum_Followupemail_Model_Source_Rule_Types::RULE_TYPE_WISHLIST_SHARED . "' ||
                    $('event_type').getValue() == '"
            . Westum_Followupemail_Model_Source_Rule_Types::RULE_TYPE_WISHLIST_PRODUCT_ADD . "')
                {
                    $('sku').up(1).show();
                    $('sale_amount_container').hide();
                }
    ...
    public function getHeaderText()
    {
        ...
        if ($data && isset($data['title']) && $data['title']) {
            return $this->__("Edit Rule '%s'", $this->escapeHtml($data['title']));
        } else {
