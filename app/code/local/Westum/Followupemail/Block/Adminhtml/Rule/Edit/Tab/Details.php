...
class Westum_Followupemail_Block_Adminhtml_Rule_Edit_Tab_Details extends Mage_Adminhtml_Block_Widget_Form
{
        ...
        if (!Mage::app()->isSingleStoreMode()) {
            ...
            if (isset($data['store_ids'])) {
                if (is_array($data['store_ids'])) {
                    if (isset($data['store_ids'][0])) {
                        $data['store_ids'] = $data['store_ids'][0];
                    } else {
                        $data['store_ids'] = '';
                    }
                }
