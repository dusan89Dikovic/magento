...
class Westum_Followupemail_Block_Adminhtml_Rule_Edit_Tab_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    protected function getCategoryIds()
    {
        ...
        if ($id) {
            $categoryIds = array_unique(
                explode(',', Mage::getModel('followupemail/rule')->load($id)->getCategoryIds())
            );
        }
        return $categoryIds;
    }
