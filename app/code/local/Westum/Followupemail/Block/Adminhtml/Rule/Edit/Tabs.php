...
class Westum_Followupemail_Block_Adminhtml_Rule_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        ...
        $this->addTab(
            ...
            array(
                ...
                'content' => $this->getLayout()->createBlock('followupemail/adminhtml_rule_edit_tab_subscribers')
                        ->toHtml(),
            )
        );
        ...
        $this->addTab(
            ...
            array(
                ...
                'content' => $this->getLayout()->createBlock('followupemail/adminhtml_rule_edit_tab_sendcopy')
                        ->toHtml(),
            )
        );
        ...
        if (Mage::helper('followupemail/coupon')->canUseCoupons()) {
            $this->addTab(
                ...
                array(
                    ...
                    'content' => $this->getLayout()->createBlock('followupemail/adminhtml_rule_edit_tab_coupons')
                            ->toHtml()
                )
            );
        }
        ...
        $this->addTab(
            ...
            array(
                ...
                'content' => $this->getLayout()->createBlock('followupemail/adminhtml_rule_edit_tab_sendtest')
                        ->toHtml(),
            )
        );
        ...
        $this->addTab(
            ...
            array(
                ...
                'content' => $this->getLayout()->createBlock('followupemail/adminhtml_rule_edit_tab_cross')->toHtml(),
            )
        );
