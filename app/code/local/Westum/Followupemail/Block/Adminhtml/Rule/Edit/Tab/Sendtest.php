...
class Westum_Followupemail_Block_Adminhtml_Rule_Edit_Tab_Sendtest extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset(
            'followupemail_sendtest_objects', array('legend' => $this->__('Test object IDs'))
        );
        ...
        $fieldset->addField(
            ...
            array(
                ...
                'note'  => $this->__('The ID of the customer') . '<br>'
                    . $this->__('If not specified, random value will be used'),
        ...
        $fieldset->addField(
            ...
            array(
                ...
                'note'  => $this->__('The email of the customer') . '<br>'
                    . $this->__('If not specified, random value will be used'),
        ...
        $fieldset->addField(
            ...
            array(
                ...
                'label' => $this->__('Order #'),
                'title' => $this->__('Order #'),
                'note'  => $this->__('The Increment ID of the order') . '<br>'
                    . $this->__('If not specified, random value will be used'),
        ...
        $fieldset->addField(
            ...
            array(
                ...
                'note'  => $this->__('The ID of the cart') . '<br>'
                    . $this->__('If not specified, random value will be used'),
        ...
        $fieldset->addField(
            ...
            array(
                ...
                'note'  => $this->__('The ID of the product') . '<br>'
                    . $this->__('If not specified, random value will be used'),
        ...
        $fieldset->addField(
            'test_resume_code', 'text',
            array(
                'name'  => 'test[resume_code]',
                'label' => $this->__('Resume code'),
                'title' => $this->__('Resume code'),
                'note'  => $this->__(
                    'The resume code is used to authorize the customer '
                    . 'when he/she comes back by the link sent in email'
                ),
