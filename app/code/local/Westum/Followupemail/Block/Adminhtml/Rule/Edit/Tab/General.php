...
class Westum_Followupemail_Block_Adminhtml_Rule_Edit_Tab_General extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            array(
                ...
                'name' => 'is_active',
                'values' => Westum_Followupemail_Model_Source_Rule_Status::toOptionArray(),
            )
        );
        ...
        $fieldset->addField(
            ...
            array(
                'label' => $this->__('Event'),
                'name' => 'event_type',
                'values' => Westum_Followupemail_Model_Source_Rule_Types::toOptionArray(),
                'required' => true,
        ...
        $fieldset->addField(
            ...
            array(
                ...
                'name' => 'cancel_events[]',
                'values' => Westum_Followupemail_Model_Source_Rule_Types::toOptionArray(TRUE),
        ...
        $fieldset->addField(
            ...
            array(
                ...
                'required' => true,
                'values' => Westum_Followupemail_Model_Source_Customer_Group::toOptionArray(),
            )
        );
        ...
        $form->getElement('sale_amount_value')->setRenderer(
            $this->getLayout()->createBlock('followupemail/adminhtml_rule_edit_tab_details_saleamount')
        );
        ...
        $form->getElement('chain')->setRenderer(
            $this->getLayout()->createBlock('followupemail/adminhtml_rule_edit_tab_details_chain')
        );
